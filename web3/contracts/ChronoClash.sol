...
contract ChronoClash is ERC1155, Ownable, ERC1155Supply {
  string public baseURI; // baseURI where token metadata is stored
  uint256 public totalSupply; // Total number of tokens minted
  uint256 public constant TEEBLINKS = 0;
  uint256 public constant ROCCO = 1;
  uint256 public constant MUBS = 2;
  uint256 public constant ANATE = 3;
  uint256 public constant ROQEEBAH = 4;
  uint256 public constant MATEX = 5;
